...
void // TODO: Yes
si5351_outputEnable(uint8_t outputNumber)
{
...
void //Works! //TODO: Replace by hard-coding PLL A to 750 MHz in init function
...
bool // TODO: Implement turning off output when below 4 kHz
...
si5351_init()
{
  ...
  void //Works // TODO: hard code divide by 4 to off
SI5351_updateMsParam(uint8_t msNumber, uint32_t ms_intPart, uint32_t ms_numerPart, uint32_t ms_denomPart, uint8_t R_OutputDividerDec, uint8_t ms_divBy4En)
{
  ...
  */
  ...
  void //Works // TODO: Add disable param, fix source to PLL A, integer mode to false, and inverted output to false
...
uint8_t //buggy??? // TODO: try to remove or fix
